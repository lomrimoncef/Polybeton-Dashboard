            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Vente / produit</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div>
                                        <div class="p-2">
                                            <h3 class="font-size-16"><strong>Rapport de vente /Produit du :
                                                    <span class="btn btn-info"> {{ $sdate }} </span> - au
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><strong>Quantite vendue</strong>
                                                        </td>
                                                    ...
                                                    @foreach($orders as $key => $item)
                                                        ...
                                                        @php
                                                            ...
                                                            $cus = App\Models\Product::where('id',$item->product_id)->first();
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center " style="background-color: #bedeb8" ><h5>{{ $item->total_sales }}</h5></td>
