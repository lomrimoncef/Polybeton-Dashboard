    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                <h4 class="float-end font-size-16"><strong>BL No # {{ $invoice->invoice_no }}</strong></h4>
                <h3>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr class="table-primary">
            ...
            <td class="text-center"><strong>Libelle Produit</strong>
            </td>
            <td class="text-center"><strong>Date BL</strong>
            </td>
            <td class="text-center"><strong>Quantity Demande</strong>
            </td>
            <td class="text-center"><strong>Prix unitaire </strong>
            </td>
            <td class="text-center" ><strong>Montant TTC</strong>
            </td>
      ...
      @php
        ...
        @endforeach
            <tr>
                ...
                <td class="thick-line text-end">{{  number_format($total_sum, 2, ',', ' ') }} DA</td>
            </tr>
            <tr>
                <td class="no-line"></td>
                 <td class="no-line"></td>
                ...
                <td class="no-line text-end">0.00 DA</td>
            </tr>
             <tr>
                <td class="no-line"></td>
                 <td class="no-line"></td>
            ...
            <tr>
                ...
                <td class="no-line"></td>
                <td class="no-line text-center table-success">

                <h4 class="m-0"> Net a payer :  {{  number_format($payment->total_amount, 2, ',', ' ') }}DA  </h4></td>
            </tr>
                            </tbody>
                        </table>
                    </div>
