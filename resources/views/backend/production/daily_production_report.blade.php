                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Journal de Production / Produit </h4><br><br>

                            <form method="GET" action="{{ route('daily.production.pdf') }}" target="_blank" id="myForm">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="md-3 form-group">
                                            <label for="example-text-input" class="form-label">Date_Debut</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="md-3 form-group">
                                            <label for="example-text-input" class="form-label">Date_Fin</label>
