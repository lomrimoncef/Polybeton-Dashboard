...
@section('admin')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Ajouter un retour_Client  </h4><br><br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label">RC No</label>
                                        <input class="form-control example-date-input" name="invoice_no" type="text" value="{{ $retour_no }}"  id="invoice_no" readonly style="background-color:#ddd" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="md-3">
                                        ...
                                        <i class="btn btn-secondary btn-rounded waves-effect waves-light fas fa-plus-circle addeventmore"> Ajouter une ligne</i>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('ret.store') }}">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="paid_amount" class="form-control paid_amount" placeholder="Enter Paid Amount" style="">
                                    </div>
    ...
    <script id="document-template" type="text/x-handlebars-template">
        ...
        <tr class="delete_add_more_item" id="delete_add_more_item">
            ...
            <td>
                <div class="form-group col-md-12">
                <textarea  class="form-control" type="text" name="category_id[]" value="@{{category_id}}"></textarea>
                @{{ category_name }}
            ...
            <td>
                <input type="number" class="form-control unit_price text-right" name="unit_price[]" value="@{{current_price}}" >
            </td>

            <td>

                <input type="number" min="0" class="form-control tva text-right" name="tva[]" value="">
